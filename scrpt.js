var Head = [
    ...
    [10, "Minor Cut", "1", "The strike opens your cheek and blood flies everywhere. Gain 1 Bleeding Condition"],
    ...
    [5, "Concussive Blow", "4", "Your brain rattles in your skull as blood spurts from your nose and ears. Take 1 Deafened, 2 Bleeding, and <a onclick=\"rollDie(this)\">1d10</a> Stunned Conditions. Gain a Fatigued Condition that lasts for <a onclick=\"rollDie(this)\">1d10</a> days. If you receive another Critical Wound to your head while suffering this Fatigued Condition, make an Average (+20) Endurance Test or also gain an Unconscious Condition"],
    [5, "Smashed Mouth", "4", "With a sickening crunch, your mouth is suddenly filled with broken teeth and blood. Gain 2 Bleeding Conditions. Lose <a onclick=\"rollDie(this)\">1d10</a> teeth - Amputation (Easy)"],
    ...
    [3, "Mangled Jaw", "5", "The blow almost removes your jaw as it utterly destroys your tongue, sending teeth flying in a shower of blood. Gain 4 Bleeding and 3 Stunned Conditions. Make a Very Hard (-30) Endurance Test or gain an Unconscious Condition. Suffer a Broken Bone (Major) injury and lose your tongue and <a onclick=\"rollDie(this)\">1d10</a> teeth - Amputation (Hard)"],
...
var Body = [
    ...
    [5, "Winded", "2", "Gain a Stunned Condition. Make an Average (+20) Endurance Test, or gain the Prone Condition. Movement is halved for <a onclick=\"rollDie(this)\">1d10</a> rounds as you get your breath back"],
...
var Leg = [
    ...
    [5, "Carved Shin", "4", "The weapon drives clean through your leg by the knee, slicing into bone and through tendons. Gain a Stunned and Prone Condition. Further, suffer a Torn Muscle (Major) and Broken Bone (Minor) injury"],
    ...
    [3, "Severed Foot", "5", "Your foot is severed at the ankle and lands <a onclick=\"rollDie(this)\">1d10</a> feet away in a random direction - Amputation (Hard) (see Scatter). You gain 3 Bleeding, 2 Stunned, and 1 Prone Condition"],
